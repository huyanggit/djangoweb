...
class UserProfile(AbstractUser):
    nick_name =models.CharField(max_length=10,default="",verbose_name=u'昵称')
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u"验证码类型",choices=(("register",u"注册"),("forget",u"找回验证码")),max_length=10)
...
class Banner(models.Model):
    ...
    url = models.URLField(max_length=100,verbose_name=u"图片地址")
